...
class SokobanEncoder:
    ...
    def encode(self):
        ...
        self.cnf.append(self.var_box(i, self.boxes[i], 0) for i in self.num_boxes)

        clauses_for_each_dir = []
